...
{
    public class OracleLogisticaRepository:IOracleLogisticaRepository
    {
        private readonly DataAcces _dbConnection;

        public OracleLogisticaRepository(DataAcces dbConnection)
        {
        ...
        public async Task<ResultadoCargaMasiva> PostOracleLogisticaMasivo(List<OracleLogistica> registros, string usuario)
        {
            ...
            return new ResultadoCargaMasiva { Estado = "Error", Mensaje = "Error desconocido." };
        }
        ...
        public async Task<List<MatchResumenDto>> ObtenerConciliacionesAsync(FiltroInsertarConciliar filtro)
        {
