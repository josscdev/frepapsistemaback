...
namespace RombiBack.Repository.ROM.ENTEL_TPF.MGM_MantenimientoTPF.MGM_BundleTPF
{
    public class BundleTPFRepository : IBundleTPFRepository
    {
        private readonly DataAcces _dbConnection;
        private readonly string _AWSMessageCA;

        public BundleTPFRepository(DataAcces dbConnection, IConfiguration configuration)
        {
