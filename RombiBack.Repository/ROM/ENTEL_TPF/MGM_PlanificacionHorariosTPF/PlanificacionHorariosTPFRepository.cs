...
namespace RombiBack.Repository.ROM.ENTEL_TPF.MGM_PlanificacionHorarios
{
    public class PlanificacionHorariosTPFRepository
    {
        private readonly DataAcces _dbConnection;

        public PlanificacionHorariosTPFRepository(DataAcces dbConnection)
        {
        ...
        public async Task<Respuesta> PostTurnosSupervisorTPF(TurnosSupervisorRequest turnosSupervisor)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(_dbConnection.GetConnectionROMBI()))
